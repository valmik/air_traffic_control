classdef Aircraft < handle
    ...
    methods
        ...
        function obj = set_yalmip_constraints(obj, timesteps)
            ...
            % timesteps is either a sdpvar or double of length N. It's the
            ...
            if (~isempty(obj.nonlinear_constraints))
                for k = 1:obj.N
                    cons = [cons, [obj.nonlinear_constraints(obj.x_yalmip(:,k), ...
                        obj.u_yalmip(:,k)) <= 0 ]:[obj.id, ' nonlinear constraints']];
                end
            end
            ...
            if (~isempty(obj.linear_dynamics_a))
                for k = 1:obj.N
                    cons = [cons, [obj.x_yalmip(:, k+1) == ...
                        ...
                        obj.linear_dynamics_b * obj.u_yalmip(:, k) ...
            ...
            if (~isempty(obj.nonlinear_dynamics))
                for k = 1:obj.N
                    cons = [cons, [obj.x_yalmip(:, k+1) == ...
                        obj.nonlinear_dynamics(obj.x_yalmip(:, k), ...
                        obj.u_yalmip(:, k), timesteps(k)) ...
